...
<p align="center">
      <img style="width:100%"  src="https://telegra.ph/file/66f4cbd1978ddd57cd034.jpg"></p>
<h1 align="center"><b>JaNa Robot</b></h1>
...
-   `DEV_USERS`            : ID of users who are Devs of your bot (can use /py etc.). If you are a noob and would come and bother Shikari support then keep the current ID's here at they are and add yours. 
-   `sw_api`               : Spamwatch API Token
