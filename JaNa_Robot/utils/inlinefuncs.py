...
from JaNa_Robot import (
    DEV_USERS,
    EVENT_LOGS, 
    BOT_USERNAME,
    ubot2,
)
from JaNa_Robot import pbot as app 
from JaNa_Robot import arq
from JaNa_Robot.services.keyboard import Ikb
from JaNa_Robot.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from JaNa_Robot.services.tasks import _get_tasks_text, all_tasks, rm_task
from JaNa_Robot.services.types import InlineQueryResultCachedDocument
from JaNa_Robot.modules.info import get_chat_info, get_user_info
from JaNa_Robot.modules.music import download_youtube_audio
from JaNa_Robot.utils.functions import test_speedtest
from JaNa_Robot.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/bc754951ddc1d771f4768.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="http://t.me/JaNa_RoBoT"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[JaNa Robot ❤️](https://t.me/ShikariSupportNetwork):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/Shiikariii)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph/file/70e52cc0218c052498d11.jpg",
            input_message_content=InputTextMessageContent(
