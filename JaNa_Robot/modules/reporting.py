...
from JaNa_Robot import LOGGER, DRAGONS, TIGERS, WOLVES, dispatcher
...
from JaNa_Robot.modules.sql import reporting_sql as sql
...
def report(update: Update, context: CallbackContext) -> str:
    ...
    if chat and message.reply_to_message and sql.chat_should_report(chat.id):
        ...
        if reported_user.id in REPORT_IMMUNE_USERS:
            message.reply_text("Uh? You reporting a Kingdom Association?")
            return ""
