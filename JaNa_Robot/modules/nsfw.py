...
from JaNa_Robot import dispatcher, updater
import JaNa_Robot.modules.sql.nsfw_sql as sql
from JaNa_Robot.modules.log_channel import gloggable
...
def add_nsfw(update: Update, context: CallbackContext):
    ...
    user = update.effective_user #Remodified by @Shiikariii @EverythingSuckz
