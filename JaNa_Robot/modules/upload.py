...
from JaNa_Robot import telethn as bot
from JaNa_Robot.modules.urluploader import download_file
from JaNa_Robot.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By *JaNaRobot*",
            )
        except Exception as e:
            traceback.print_exc()
