...
import JaNa_Robot.modules.sql.feds_sql as sql
...
from JaNa_Robot.modules.helper_funcs.string_handling import markdown_parser
...
def new_fed(update: Update, context: CallbackContext):
    ...
    if not fednam == "":
        ...
        # if fednam == 'The Shikari':
        # fed_id = "ShikariSupportNetwork"
...
def fed_ban(update: Update, context: CallbackContext):
    ...
    if fban:
        fed_name = info["fname"]
        # https://t.me/ShikariSupportNetwork // https://t.me/ShikariSupportNetwork
