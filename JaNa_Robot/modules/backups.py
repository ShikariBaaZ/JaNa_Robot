...
import JaNa_Robot.modules.sql.notes_sql as sql
from JaNa_Robot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from JaNa_Robot.__main__ import DATA_IMPORT
from JaNa_Robot.modules.helper_funcs.chat_status import user_admin
from JaNa_Robot.modules.helper_funcs.alternate import typing_action

# from JaNa_Robot.modules.rules import get_rules
import JaNa_Robot.modules.sql.rules_sql as rulessql

# from JaNa_Robot.modules.sql import warns_sql as warnssql
import JaNa_Robot.modules.sql.blacklist_sql as blacklistsql
from JaNa_Robot.modules.sql import disable_sql as disabledsql

# from JaNa_Robot.modules.sql import cust_filters_sql as filtersql
# import JaNa_Robot.modules.sql.welcome_sql as welcsql
import JaNa_Robot.modules.sql.locks_sql as locksql
from JaNa_Robot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("JaNa_Robot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("JaNa_Robot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `JaNa_Robot-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("JaNa_Robot{}.backup".format(chat_id))  # Cleaning file
